const projects = [
  {
    ...
    description: `
      <p>Pozos del cielo es una instalación lumínica que reflexiona sobre el tránsito espacial y la creciente carrera aeroespacial en la que nos vemos inmersos. Se inspira en las esculturas con el mismo nombre de Jean Nouvel, ubicadas en el parque del centro de Poble Nou, Barcelona. La obra retoma la idea original del arquitecto: una ventana al cielo que deja pasar la luz a través de una densa manta vegetal, concebida para envolver el parque con el tiempo. En su momento, Nouvel buscaba responder a la preocupación por la contaminación urbana, ofreciendo un respiro visual y un vínculo con el cielo en medio de la ciudad. Ahora, años después, nos preguntamos qué más nos revelaría este pozo y qué otras cosas, además de luz, podrían filtrarse a su interior.</p>
      <p>Si miramos al cielo en plena oscuridad, encontramos la luna, las estrellas, los cuerpos celestes que evocan paz y pureza, pero junto a ellos también orbitan satélites, fragmentos de basura espacial y naves aeroespaciales. La ocupación del espacio exterior ha crecido exponencialmente, y la cantidad de satélites en órbita sigue en aumento. La instalación reinterpreta la obra de Nouvel a la luz de esta transformación, estableciendo un diálogo entre su visión original y la realidad tecnológica actual.</p>
      <p>Este proyecto se realizó para el festival Llum 2025 de Barcelona, un evento anual celebrado en el barrio de Poble Nou que reúne a miles de visitantes. Participando en nombre de BAU, Centre Universitari d’Arts i Disseny, desarrollamos la obra con un equipo de ocho personas a través de un trabajo multidisciplinario que combinó diseño, fabricación digital, sistemas eléctricos y programación.</p>
      <p>Para su desarrollo, fabricamos nuestras propias barras de luces LED, que se sincronizaran mediante protocolo Art-Net para obedecer a una coreografía lumínica específica. La obra, siendo site-specific para una locación exterior, planteó desafíos técnicos relacionados con la alimentación de energía y la comunicación entre los distintos dispositivos. Así diseñamos un sistema eficiente que garantizara la estabilidad operativa de la instalación, asegurando su correcto funcionamiento en un entorno cambiante y expuesto a las condiciones climáticas.</p>
      <p>Mi rol dentro del equipo fue el de dirección de producción, supervisando la fabricación digital y tomando decisiones estratégicas durante su desarrollo. También fui responsable del diseño del sistema eléctrico y la iluminación, asegurando su implementación y correcta operación, además de una contribución constante en la investigación, conceptualización y programación de la obra.</p>,
  ...
  { 
    ...
    category: 'Instalaciones y obras artísticas', 
    description: `
      <p>Una pieza artística interactiva (de un total de tres) desarrollada en colaboración con la artista ceramista Lili Díaz y la cantante Camila Terán, que formó parte de la exposición "Puede ser en el Bosque", una propuesta inmersiva en la naturaleza donde diversas disciplinas artísticas se entrelazaron con el paisaje. Inspirada en la leyenda de "La Loba", que relata la transformación de un esqueleto de lobo en mujer a través del canto, la obra invita al espectador a un acto de escucha y descubrimiento.</p>
      <p>Suspendida en medio del bosque, la escultura de cerámica albergaba en su centro una aureola de estrellas, evocando el simbolismo de lo sagrado. A primera vista, la pieza transmitía un aura de quietud, pero al acercarse, los visitantes se sumergían en un juego de voces y sonidos guturales que resonaban desde su interior. Aullidos, risas y cantos ancestrales emergían de la escultura, pero al dar un paso más hacia la aureola, la experiencia se transformaba: un sensor de proximidad activaba un mensaje secreto, susurrado al oído de cada espectador, único e irrepetible.</p>
      <p>Mi labor en este proyecto fue dar vida a esta interacción sonora. Diseñé un sistema electrónico analógico-digital que permitiera a la pieza "hablar", utilizando sensores de proximidad para generar una respuesta a la cercanía del espectador. Para lograrlo, desarrollé un dispositivo compacto e integrado, empleando fabricación digital y materiales que se fundieran con la cerámica de Lili y el entorno natural. Además, debido a la ubicación en el bosque, diseñé un sistema autónomo y transportable que evitara cableados externos y respetara la integridad de la instalación.</p>
      <p>Otro aspecto fundamental fue la creación y producción del paisaje sonoro. Con la participación de Camila grabamos y editamos una combinación de sonidos humanos y naturales, utilizando sampling, diseño sonoro y programación para construir un universo sonoro envolvente. Cada susurro, cada canto y cada sonido gutural estaban pensados para evocar la esencia mítica del relato y provocar una reacción íntima en quien se acercara a escuchar.</p>
      <p>El impacto de la pieza fue notorio. La interacción con la obra generó una respuesta emocional genuina en el público: asombro, intriga y reflexión. Ver a los visitantes acercarse con cautela, recibir un mensaje único y alejarse pensativos fue la confirmación de que la combinación entre arte, tecnología y narrativa había funcionado. Una colaboración que resultó en una obra viva, que dialogó con su entorno y con quienes se atrevieron a escuchar sus secretos.</p>
    `,
    visuals: [
      { image: 'Loba_1.jpg' },
      { image: 'Loba_2.JPG' },
