const projects = [
  {
    ...
    description: `
      ...
      <p>Para su desarrollo, fabricamos nuestras propias barras de luces LED, que se sincronizaran mediante el protocolo Art-Net para obedecer a una coreografía lumínica específica. La obra, siendo site-specific para una locación exterior, planteó desafíos técnicos relacionados con la alimentación de energía y la comunicación entre los distintos dispositivos. Así diseñamos un sistema eficiente que garantizara la estabilidad operativa de la instalación, asegurando su correcto funcionamiento en un entorno cambiante y expuesto a las condiciones climáticas.</p>
      <p>Mi rol dentro del equipo fue el de dirección de producción, supervisando la fabricación digital y tomando decisiones estratégicas durante su desarrollo. También fui responsable del diseño del sistema eléctrico y la iluminación, asegurando su implementación y correcta operación, además de contribuir en la investigación, conceptualización y programación de la obra.</p>
