const projects = [
  {
    ...
    description: `
      <p>Pozos del cielo es una instalación lumínica que reflexiona sobre el tránsito espacial y la creciente carrera aeroespacial en la que nos vemos inmersos. Inspirada en las esculturas Pozos del Cielo de Jean Nouvel, del parque del centro de Poble Nou, Barcelona, la obra parte de la idea original del arquitecto: una ventana al cielo que filtra la luz a través de una densa manta vegetal, pensada para envolver el parque con el tiempo. En su momento, Nouvel respondía a la preocupación por la contaminación urbana, ofreciendo un respiro visual y una conexión con el cielo en medio de la ciudad. Ahora, años después, nos preguntamos qué más nos mostraría este pozo y qué otras cosas, además de luz, podrían filtrarse a su interior.</p>
