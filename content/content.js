const projects = [
  {
    ...
    description: `
      ...
      <p>Este proyecto se realizó para el festival Llum 2025 de Barcelona, un evento anual celebrado en el barrio de Poble Nou que reúne a miles de visitantes. Participando en nombre de BAU, Centre Universitari d’Arts i Disseny, desarrollamos la obra con un equipo de ocho personas a través de un trabajo multidisciplinario que combinó diseño, fabricación digital, sistemas eléctricos y programación para dar forma a la instalación final.</p>
      <p>Para su desarrollo, fabricamos nuestras propias barras de luces LED, que mediante el protocolo Art-Net pudieran ser sincronizadas con una coreografía lumínica específica. La obra, siendo site-specific para una locación exterior, planteó desafíos técnicos relacionados con la alimentación de energía y la comunicación entre los distintos dispositivos. Diseñamos un sistema eficiente que garantizara la estabilidad operativa de la instalación, asegurando su correcto funcionamiento en un entorno cambiante y expuesto a las condiciones climáticas.</p>
      <p>Mi rol dentro del equipo fue el de dirección de producción, supervisando la fabricación digital y tomando decisiones estratégicas durante su desarrollo. También fui responsable del diseño del sistema eléctrico y la iluminación, asegurando su implementación y correcta operación. Además, participé en la investigación, conceptualización y programación de la obra.</p>
